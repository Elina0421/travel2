...
- **Презентация:** [](https://docs.google.com/presentation/d/12aaxo6tdc0B4P1e43FvfsCbwqEp55uV1G9-nLlv9vqs/edit?usp=sharing)
...
| Таблица  | Назначение                                      |
|----------|-------------------------------------------------|
| `users`  | Данные пользователей (статус, от куда летим, куда летим, бюджет, обратный рейс или нет, дату рейса, в какое время примерно рейс, )     |
